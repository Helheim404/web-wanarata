...
class Model_app extends CI_model{
    ...
    public function hitunggallery(){
        return $this->db->query("SELECT * FROM gallery WHERE aktif='Y'");
    }
    public function semua_gallery($dari,$limit){
        return $this->db->query("SELECT * FROM gallery ORDER BY id_gallery DESC LIMIT $dari,$limit");
    }
